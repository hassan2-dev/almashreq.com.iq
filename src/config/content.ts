...
export const partners = [
  { name: 'IGOL', description: 'موزع معتمد', tags: ['زيوت'], logo: '/partners/igol.png' },
  { name: 'Mobil', description: 'وكيل', tags: ['زيوت'], logo: '/partners/mobil.png' },
  { name: 'ACDelco', description: 'موزع', tags: ['فلاتر', 'بطاريات'], logo: '/partners/acdelco.png' },
  { name: 'Rudson', description: 'موزع', tags: ['زيوت'], logo: '/partners/rudson.png' },
];
